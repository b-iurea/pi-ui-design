...
export function updateThemeFromUI(): void {
	...
	S.theme.primary =
		(g("theme-primary") as HTMLInputElement)?.value || S.theme.primary;
	...
	S.theme.spacing =
		(g("theme-spacing") as HTMLSelectElement)?.value || S.theme.spacing;
	S.theme.radius =
		(g("theme-radius") as HTMLSelectElement)?.value || S.theme.radius;
